...
function kartTiklama(olay) {
    ...
    if (acikKartImg.src === secilenKartImg.src) {
        ...
        if (puan == 4){
            ...
            congrats.src = 'https://img1.picmix.com/output/stamp/normal/7/1/7/3/1183717_3e709.gif';
...
function onClick(){
    ...
    imgEtiketi.src = `https://picsum.photos/100/100 `
    document.querySelector('body').append(imgEtiketi)}
